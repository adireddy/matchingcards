...
:: Android packaging
set AND_CERT_NAME="MatchingCards"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\MatchingCards.p12
...
set IOS_DEV_CERT_PASS=adi
set IOS_PROVISION=cert\MatchingCards.mobileprovision
set IOS_DIST_PROVISION=cert\MatchingCardsDist.mobileprovision
...
set APP_ID=com.ai.MatchingCards

:: Output packages
set DIST_PATH=dist
set DIST_NAME=MatchingCards
